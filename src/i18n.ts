  ...
  en: {
    translation: {
      ...
      application: {
        ...
        placeholders: {
          organization: "e.g. UN, World Bank, XYZ Corp",
          name: "John Doe",
          email: "john@example.com",
          phone: "+998 90 123 45 67",
          service: "e.g. Field Mission / Airport Transfer",
          dates: "DD/MM/YYYY - DD/MM/YYYY",
          route: "Tashkent - Samarkand - Bukhara",
          passengers: "Number of passengers",
          message: "Any special requirements or details..."
        },
    ...
    translation: {
      ...
      application: {
        ...
        fields: {
          ...
          upload: "Загрузить маршрут (Опционально)",
          message: "Дополнительная информация"
        },
        placeholders: {
          organization: "напр. ООН, Всемирный банк, ООО Ромашка",
          name: "Иван Иванов",
          email: "ivan@example.com",
          phone: "+998 90 123 45 67",
          service: "напр. Полевая миссия / Трансфер",
          dates: "ДД/ММ/ГГГГ - ДД/ММ/ГГГГ",
          route: "Ташкент - Самарканд - Бухара",
          passengers: "Количество пассажиров",
          message: "Особые пожелания или детали..."
        },
    ...
    translation: {
      ...
      application: {
        ...
        fields: {
          ...
          route: "Viloyatlar / Shaharlar",
          passengers: "Yo'lovchilar soni",
          upload: "Marshrutni yuklash (Ixtiyoriy)",
          message: "Qo'shimcha ma'lumot"
        },
        placeholders: {
          organization: "masalan, BMT, Jahon Banki",
          name: "Eshmat Toshmatov",
          email: "eshmat@example.com",
          phone: "+998 90 123 45 67",
          service: "masalan, Dala missiyasi / Transfer",
          dates: "KK/OO/YYYY - KK/OO/YYYY",
          route: "Toshkent - Samarqand - Buxoro",
          passengers: "Yo'lovchilar soni",
          message: "Maxsus talablar yoki tafsilotlar..."
        },
